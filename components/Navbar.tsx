        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center">
            <svg
              ...
              className="w-10 h-10 text-purple-400 transition-transform duration-300 hover:scale-105"
              viewBox="0 0 24 24"
            >
              <path
                fill="currentColor"
          ...
          <div className="relative cursor-pointer" onClick={toggleDropdown}>
            {/* <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-6 h-6 text-purple-400 transition-transform duration-300 hover:scale-105"
              viewBox="0 0 24 24"
            >
              <path
                fill="currentColor"
            ...
            {/* Dropdown Menu */}
            {/* {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-600 rounded-lg shadow-lg">
                 */}
                 <div className="flex flex-col p-2 justify-center items-center border border-gray-600 rounded-lg shadow-lg">
                  <button
                    className="text-gray-300 text-sm font-semibold hover:text-purple-400 transition-colors duration-200"
